# word problems
# demonstrate numbers and math

print("If a 1000 pound pregnant elephant gives birth to a 50 pound baby,")
print("but then eats 50 pounds of food, how much does she weigh?")
input("Press the enter key to find out.")
print("2000 - 100 + 50 =", 2000 - 100 + 50)

print("\nIf an adventurer returns from a successful mission and buys each of")
print("6 companions 3 bottles of henesy, how many bottles are purchased?")
input("Press the enter key to find out.")
print("6 * 3 =", 6 * 3)
